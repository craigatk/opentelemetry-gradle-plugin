...
Starting in plugin version `3.0.0` you can configure the plugin to pass the trace ID and span ID for the build
...
The environment variables are named `TRACE_ID` and `SPAN_ID` by default.
